...
| --- | --- | --- | --- |
| Operation API and CLI tool surface | `src/operations/`, `src/cli/`, `tests/test_operation_host.c` | TBD | `@DeusData` |
...
| Packaging and distribution | `pkg/`, `install.sh`, `install.ps1`, `flake.nix`, `flake.lock`, `THIRD_PARTY.md`, `scripts/gen-third-party-notices.sh`, `scripts/gen-ui-licenses.py`, release archive contents | TBD | `@DeusData` |
