...
#define CADD_FUNC(rcv, sn, qn, ret_type)                                           \
    do {                                                                           \
...
void cbm_rust_crates_register(CBMTypeRegistry *reg, CBMArena *arena) {
    ...
    CADD_FUNC("serde.Deserialize", "deserialize", "serde.Deserialize.deserialize",
              cbm_type_unknown());
    ...
    CADD_FUNC("anyhow.Error", "context", "anyhow.Error.context",
              cbm_type_named(arena, "anyhow.Error"));
    ...
    CADD_FUNC("tokio.runtime.Runtime", "block_on", "tokio.runtime.Runtime.block_on",
              cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Runtime", "spawn", "tokio.runtime.Runtime.spawn", cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Runtime", "handle", "tokio.runtime.Runtime.handle",
              cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Runtime", "shutdown_timeout", "tokio.runtime.Runtime.shutdown_timeout",
              t_unit);
    CADD_FUNC("tokio.runtime.Builder", "new_multi_thread", "tokio.runtime.Builder.new_multi_thread",
              cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Builder", "new_current_thread",
              "tokio.runtime.Builder.new_current_thread", cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Builder", "worker_threads", "tokio.runtime.Builder.worker_threads",
              cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Builder", "enable_all", "tokio.runtime.Builder.enable_all",
              cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Builder", "build", "tokio.runtime.Builder.build", cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Handle", "current", "tokio.runtime.Handle.current",
              cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Handle", "spawn", "tokio.runtime.Handle.spawn", cbm_type_unknown());
    CADD_FUNC("tokio.runtime.Handle", "block_on", "tokio.runtime.Handle.block_on",
              cbm_type_unknown());
    ...
    CADD_FUNC("tokio.sync.Semaphore", "acquire", "tokio.sync.Semaphore.acquire",
              cbm_type_unknown());
    ...
    CADD_FUNC("tokio.sync.mpsc.Sender", "try_send", "tokio.sync.mpsc.Sender.try_send",
              cbm_type_unknown());
    CADD_FUNC("tokio.sync.mpsc.Receiver", "recv", "tokio.sync.mpsc.Receiver.recv",
              cbm_type_unknown());
    CADD_FUNC("tokio.sync.mpsc.Receiver", "try_recv", "tokio.sync.mpsc.Receiver.try_recv",
              cbm_type_unknown());
    CADD_FUNC("tokio.sync.oneshot.Sender", "send", "tokio.sync.oneshot.Sender.send",
              cbm_type_unknown());
    CADD_FUNC("tokio.sync.oneshot.Receiver", "await", "tokio.sync.oneshot.Receiver.await",
              cbm_type_unknown());
    CADD_FUNC("tokio.net.TcpListener", "bind", "tokio.net.TcpListener.bind", cbm_type_unknown());
    CADD_FUNC("tokio.net.TcpListener", "accept", "tokio.net.TcpListener.accept",
              cbm_type_unknown());
    CADD_FUNC("tokio.net.TcpListener", "local_addr", "tokio.net.TcpListener.local_addr",
              cbm_type_unknown());
    CADD_FUNC("tokio.net.TcpStream", "connect", "tokio.net.TcpStream.connect", cbm_type_unknown());
    CADD_FUNC("tokio.net.TcpStream", "peer_addr", "tokio.net.TcpStream.peer_addr",
              cbm_type_unknown());
    ...
    CADD_FUNC(NULL, "spawn_blocking", "tokio.task.spawn_blocking",
              cbm_type_named(arena, "tokio.task.JoinHandle"));
    ...
    CADD_FUNC(NULL, "sleep_until", "tokio.time.sleep_until",
              cbm_type_named(arena, "tokio.time.Sleep"));
    CADD_FUNC(NULL, "interval", "tokio.time.interval",
              cbm_type_named(arena, "tokio.time.Interval"));
    ...
    CADD_FUNC("clap.Parser", "command", "clap.Parser.command",
              cbm_type_named(arena, "clap.Command"));
    ...
    CADD_FUNC("clap.Command", "subcommand", "clap.Command.subcommand",
              cbm_type_named(arena, "clap.Command"));
    CADD_FUNC("clap.Command", "about", "clap.Command.about", cbm_type_named(arena, "clap.Command"));
    CADD_FUNC("clap.Command", "version", "clap.Command.version",
              cbm_type_named(arena, "clap.Command"));
    CADD_FUNC("clap.Command", "author", "clap.Command.author",
              cbm_type_named(arena, "clap.Command"));
    CADD_FUNC("clap.Command", "get_matches", "clap.Command.get_matches",
              cbm_type_named(arena, "clap.ArgMatches"));
    CADD_FUNC("clap.Command", "get_matches_from", "clap.Command.get_matches_from",
              cbm_type_named(arena, "clap.ArgMatches"));
    ...
    CADD_FUNC("clap.Arg", "default_value", "clap.Arg.default_value",
              cbm_type_named(arena, "clap.Arg"));
    ...
    CADD_FUNC("futures.StreamExt", "filter_map", "futures.StreamExt.filter_map",
              cbm_type_unknown());
    ...
    CADD_FUNC("once_cell.sync.OnceCell", "get_or_init", "once_cell.sync.OnceCell.get_or_init",
              cbm_type_unknown());
    ...
    CADD_FUNC("reqwest.Client", "new", "reqwest.Client.new",
              cbm_type_named(arena, "reqwest.Client"));
    CADD_FUNC("reqwest.Client", "builder", "reqwest.Client.builder", cbm_type_unknown());
    CADD_FUNC("reqwest.Client", "get", "reqwest.Client.get",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.Client", "post", "reqwest.Client.post",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.Client", "put", "reqwest.Client.put",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.Client", "delete", "reqwest.Client.delete",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.Client", "request", "reqwest.Client.request",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "header", "reqwest.RequestBuilder.header",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "headers", "reqwest.RequestBuilder.headers",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "body", "reqwest.RequestBuilder.body",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "json", "reqwest.RequestBuilder.json",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "form", "reqwest.RequestBuilder.form",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "query", "reqwest.RequestBuilder.query",
              cbm_type_named(arena, "reqwest.RequestBuilder"));
    CADD_FUNC("reqwest.RequestBuilder", "send", "reqwest.RequestBuilder.send",
              cbm_type_named(arena, "reqwest.Response"));
    ...
    CADD_FUNC("rayon.iter.ParallelIterator", "map", "rayon.iter.ParallelIterator.map",
              cbm_type_unknown());
    CADD_FUNC("rayon.iter.ParallelIterator", "filter", "rayon.iter.ParallelIterator.filter",
              cbm_type_unknown());
    CADD_FUNC("rayon.iter.ParallelIterator", "for_each", "rayon.iter.ParallelIterator.for_each",
              t_unit);
    CADD_FUNC("rayon.iter.ParallelIterator", "collect", "rayon.iter.ParallelIterator.collect",
              cbm_type_unknown());
    CADD_FUNC("rayon.iter.ParallelIterator", "reduce", "rayon.iter.ParallelIterator.reduce",
              cbm_type_unknown());
    CADD_FUNC("rayon.iter.ParallelIterator", "sum", "rayon.iter.ParallelIterator.sum",
              cbm_type_unknown());
    ...
    CADD_FUNC("rayon.iter.IntoParallelIterator", "into_par_iter",
              "rayon.iter.IntoParallelIterator.into_par_iter", cbm_type_unknown());
