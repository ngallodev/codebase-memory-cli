...
#define ADD_FUNC(rcv, sn, qn, ret_type)                                            \
    do {                                                                           \
...
void cbm_rust_stdlib_register(CBMTypeRegistry *reg, CBMArena *arena) {
    ...
    /* ── Option<T> methods ──────────────────────────────────────── */
    {
        ...
        ADD_FUNC(T, "unwrap_or_default", "core.option.Option.unwrap_or_default",
                 cbm_type_unknown());
    ...
    /* ── Result<T, E> methods ───────────────────────────────────── */
    {
        ...
        ADD_FUNC(T, "unwrap_or_default", "core.result.Result.unwrap_or_default",
                 cbm_type_unknown());
    ...
    /* ── Box / Rc / Arc — focus on `new` and Deref ─────────────── */
    {
        ...
        ADD_FUNC("core.cell.RefCell", "borrow_mut", "core.cell.RefCell.borrow_mut",
                 cbm_type_unknown());
    }
    ...
    /* ── Trait method signatures (default impls go on the trait QN) ── */
    {
        ...
        ADD_FUNC("core.default.Default", "default", "core.default.Default.default",
                 cbm_type_unknown());
        ...
        ADD_FUNC("core.cmp.PartialOrd", "partial_cmp", "core.cmp.PartialOrd.partial_cmp",
                 cbm_type_unknown());
        ...
        ADD_FUNC("core.convert.TryFrom", "try_from", "core.convert.TryFrom.try_from",
                 cbm_type_unknown());
        ADD_FUNC("core.convert.TryInto", "try_into", "core.convert.TryInto.try_into",
                 cbm_type_unknown());
        ...
        ADD_FUNC("core.borrow.BorrowMut", "borrow_mut", "core.borrow.BorrowMut.borrow_mut",
                 cbm_type_unknown());
        ADD_FUNC("core.ops.Deref", "deref", "core.ops.Deref.deref", cbm_type_unknown());
        ADD_FUNC("core.ops.DerefMut", "deref_mut", "core.ops.DerefMut.deref_mut",
                 cbm_type_unknown());
    ...
    }
    {
        ...
        ADD_FUNC(T, "saturating_duration_since", "std.time.Instant.saturating_duration_since",
                 cbm_type_unknown());
        ADD_FUNC(T, "checked_duration_since", "std.time.Instant.checked_duration_since",
                 cbm_type_unknown());
    }
    {
    ...
    ADD_FUNC(NULL, "spawn", "std.thread.spawn", cbm_type_named(arena, "std.thread.JoinHandle"));
    ...
    ADD_FUNC(NULL, "current", "std.thread.current", cbm_type_named(arena, "std.thread.Thread"));
    ...
    {
        const char *atomic_types[] = {"std.sync.atomic.AtomicBool",
        ...
        for (const char **T = atomic_types; *T; T++) {
            ...
            ADD_FUNC(*T, "compare_exchange", cbm_arena_sprintf(arena, "%s.compare_exchange", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "fetch_add", cbm_arena_sprintf(arena, "%s.fetch_add", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "fetch_sub", cbm_arena_sprintf(arena, "%s.fetch_sub", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "fetch_and", cbm_arena_sprintf(arena, "%s.fetch_and", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "fetch_or", cbm_arena_sprintf(arena, "%s.fetch_or", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "fetch_xor", cbm_arena_sprintf(arena, "%s.fetch_xor", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "into_inner", cbm_arena_sprintf(arena, "%s.into_inner", *T),
                     cbm_type_unknown());
        }
    }
    /* mpsc free helpers. */
    ...
    /* ── Primitive integer / float method surfaces ────────────── */
    {
        ...
        const char *int_types[] = {"i8",  "i16", "i32", "i64",  "i128",  "isize", "u8",
                                   "u16", "u32", "u64", "u128", "usize", NULL};
        for (const char **T = int_types; *T; T++) {
            ...
            ADD_FUNC(*T, "checked_add", cbm_arena_sprintf(arena, "%s.checked_add", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "checked_sub", cbm_arena_sprintf(arena, "%s.checked_sub", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "checked_mul", cbm_arena_sprintf(arena, "%s.checked_mul", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "checked_div", cbm_arena_sprintf(arena, "%s.checked_div", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "checked_rem", cbm_arena_sprintf(arena, "%s.checked_rem", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "saturating_add", cbm_arena_sprintf(arena, "%s.saturating_add", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "saturating_sub", cbm_arena_sprintf(arena, "%s.saturating_sub", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "saturating_mul", cbm_arena_sprintf(arena, "%s.saturating_mul", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "wrapping_add", cbm_arena_sprintf(arena, "%s.wrapping_add", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "wrapping_sub", cbm_arena_sprintf(arena, "%s.wrapping_sub", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "wrapping_mul", cbm_arena_sprintf(arena, "%s.wrapping_mul", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "overflowing_add", cbm_arena_sprintf(arena, "%s.overflowing_add", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "leading_zeros", cbm_arena_sprintf(arena, "%s.leading_zeros", *T),
                     cbm_type_builtin(arena, "u32"));
            ADD_FUNC(*T, "trailing_zeros", cbm_arena_sprintf(arena, "%s.trailing_zeros", *T),
                     cbm_type_builtin(arena, "u32"));
            ADD_FUNC(*T, "count_ones", cbm_arena_sprintf(arena, "%s.count_ones", *T),
                     cbm_type_builtin(arena, "u32"));
            ADD_FUNC(*T, "count_zeros", cbm_arena_sprintf(arena, "%s.count_zeros", *T),
                     cbm_type_builtin(arena, "u32"));
            ADD_FUNC(*T, "swap_bytes", cbm_arena_sprintf(arena, "%s.swap_bytes", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "rotate_left", cbm_arena_sprintf(arena, "%s.rotate_left", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "rotate_right", cbm_arena_sprintf(arena, "%s.rotate_right", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "to_string", cbm_arena_sprintf(arena, "%s.to_string", *T),
                     t_self_named_string);
            ...
            ADD_FUNC(*T, "to_be_bytes", cbm_arena_sprintf(arena, "%s.to_be_bytes", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "to_le_bytes", cbm_arena_sprintf(arena, "%s.to_le_bytes", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "from_be_bytes", cbm_arena_sprintf(arena, "%s.from_be_bytes", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "from_le_bytes", cbm_arena_sprintf(arena, "%s.from_le_bytes", *T),
                     cbm_type_unknown());
            ...
            ADD_FUNC(*T, "is_power_of_two", cbm_arena_sprintf(arena, "%s.is_power_of_two", *T),
                     t_bool);
            ADD_FUNC(*T, "next_power_of_two", cbm_arena_sprintf(arena, "%s.next_power_of_two", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "div_euclid", cbm_arena_sprintf(arena, "%s.div_euclid", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "rem_euclid", cbm_arena_sprintf(arena, "%s.rem_euclid", *T),
                     cbm_type_unknown());
        }
        ...
        for (const char **T = float_types; *T; T++) {
            ...
            ADD_FUNC(*T, "to_radians", cbm_arena_sprintf(arena, "%s.to_radians", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "to_degrees", cbm_arena_sprintf(arena, "%s.to_degrees", *T),
                     cbm_type_unknown());
            ...
            ADD_FUNC(*T, "is_sign_positive", cbm_arena_sprintf(arena, "%s.is_sign_positive", *T),
                     t_bool);
            ADD_FUNC(*T, "is_sign_negative", cbm_arena_sprintf(arena, "%s.is_sign_negative", *T),
                     t_bool);
            ADD_FUNC(*T, "min", cbm_arena_sprintf(arena, "%s.min", *T), cbm_type_unknown());
            ADD_FUNC(*T, "max", cbm_arena_sprintf(arena, "%s.max", *T), cbm_type_unknown());
            ADD_FUNC(*T, "clamp", cbm_arena_sprintf(arena, "%s.clamp", *T), cbm_type_unknown());
            ...
            ADD_FUNC(*T, "from_bits", cbm_arena_sprintf(arena, "%s.from_bits", *T),
                     cbm_type_unknown());
            ADD_FUNC(*T, "copysign", cbm_arena_sprintf(arena, "%s.copysign", *T),
                     cbm_type_unknown());
        ...
        ADD_FUNC("char", "to_ascii_lowercase", "char.to_ascii_lowercase",
                 cbm_type_builtin(arena, "char"));
        ADD_FUNC("char", "to_ascii_uppercase", "char.to_ascii_uppercase",
                 cbm_type_builtin(arena, "char"));
    ...
    }
    {
        ...
        ADD_FUNC(T, "into_sorted_vec", "alloc.collections.BinaryHeap.into_sorted_vec",
                 cbm_type_unknown());
    }
    {
    ...
    ADD_TYPE("std.ffi.FromBytesWithNulError", "FromBytesWithNulError", false);
    {
        ...
        ADD_FUNC(T, "into_bytes_with_nul", "std.ffi.CString.into_bytes_with_nul",
                 cbm_type_unknown());
    ...
    /* ── std::collections::BinaryHeap extras ─────────────────── */
    {
        ...
        ADD_FUNC(T, "drain_sorted", "alloc.collections.BinaryHeap.drain_sorted",
                 cbm_type_unknown());
    ...
    /* ── HashSet extras ───────────────────────────────────────── */
    {
        ...
        ADD_FUNC(T, "symmetric_difference", "alloc.collections.HashSet.symmetric_difference",
                 cbm_type_unknown());
