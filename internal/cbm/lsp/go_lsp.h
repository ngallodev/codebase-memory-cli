...
typedef struct {
    ...
    const char *field_defs;     // "|"-separated "name:type" pairs (for struct fields, e.g.
                                // "Binder:Binder|Name:string")
    const char
        *method_names_str; // "|"-separated method names for interfaces (e.g. "Get|Put|Delete")
    ...
    bool is_interface;
    CBMLanguage lang; // language of the file that defined this — used by Tier 2 per-language
